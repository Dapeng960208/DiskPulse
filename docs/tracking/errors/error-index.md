...
| 错误标题 | 链接 | 出现次数 |
| --- | --- | ---: |
| 前端全量与覆盖率曾保留既有失败 | [错误详情](./frontend/baseline-test-debt.md) | 7 |
| 独立后端检查在 worktree 缺少默认配置 | [错误详情](./backend/worktree-config-yml-missing.md) | 3 |
...
| 时间转换隐式依赖宿主机时区 | [错误详情](./backend/host-timezone-dependent-datetime-normalization.md) | 1 |
