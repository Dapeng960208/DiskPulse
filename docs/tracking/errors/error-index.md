...
| 前端全量与覆盖率保留既有失败 | [错误详情](./frontend/baseline-test-debt.md) | 2 |
| 项目实时使用页签未传递完整内容高度 | [错误详情](./frontend/project-realtime-tab-content-height.md) | 1 |
| 项目详情表格纵向滚动被隐藏导致分页不可达 | [错误详情](./frontend/project-detail-table-pagination-scroll-trap.md) | 1 |
| QuestDB 遥测质量快照使用 `timestamptz` 绑定参数 | [错误详情](./backend/questdb-timestamptz-parameter-binding.md) | 1 |
