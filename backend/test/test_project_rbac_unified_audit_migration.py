...
UNIFIED_REVISION = "000000000008"
UNIFIED_MIGRATION = VERSIONS_ROOT / "000000000008_project_rbac_unified_audit.py"
...
def test_release_tracking_names_unified_migration_and_pt_data_restore_risk():
    ...
    assert "000000000008_project_rbac_unified_audit.py" in release
